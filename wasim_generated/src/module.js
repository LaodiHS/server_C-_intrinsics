...
(function() {
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 11, "filename": "/text.txt"}], "remote_package_size": 11, "package_uuid": "dc9c632e-4994-4bed-9476-3aee031532ae"});
...
var real_dynCall_ffff = asm["dynCall_ffff"];
asm["dynCall_ffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var real_dynCall_fifff = asm["dynCall_fifff"];
asm["dynCall_fifff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_fifff.apply(null, arguments);
};
